...
import {showAccordionBody} from "../controllers/accordionController";
...
class Questions extends Component{
    ...
    render() {
        return (
            <div id={"accordion"} className={"md:col-start-5 md:col-end-12 col-span-12 self-start overflow-x-auto lg:h-96 md:h-72 h-48"}>
